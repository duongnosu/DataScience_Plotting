...
plt.figure()
# This is old version of pandas
#pd.tools.plotting.parallel_coordinates(iris, 'Name')
# newversion of pandas
...
plt.figure()
# normed has been removed on the new API
...
sns.jointplot(v1, v2, kind='hex', color='pink')
...
sns.jointplot(data=iris, kind='kde')
